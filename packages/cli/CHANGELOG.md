...
- [`3d2dc8d`](https://github.com/smashah/peardrop/commit/3d2dc8d1661b4fc8c4268502a504010f838231cc)  *(patch)*
...
- [#103](https://github.com/smashah/peardrop/pull/103) [`ff6e6a5`](https://github.com/smashah/peardrop/commit/ff6e6a581ed311d0a7239b1ff17823e5591b2f5a)  *(patch)*
...
- [#82](https://github.com/smashah/peardrop/pull/82) [`6c3aa29`](https://github.com/smashah/peardrop/commit/6c3aa29719590d5585342f132383fb7437725578)  *(patch)*
  Fall back when the preferred browser relay handshake stops exchanging protocol frames, instead of waiting for the full 30-second connection timeout, after completely tearing down the failed preferred attempt.
...
- *(patch)* Version bump from group with `@peardrop/relay` v1.5.10

## 1.5.9
<sub>2026-08-13</sub>

- *(patch)* Version bump from group with `@peardrop/relay` v1.5.9

## 1.5.8
<sub>2026-08-13</sub>

- *(patch)* Version bump from group with `@peardrop/relay` v1.5.8
